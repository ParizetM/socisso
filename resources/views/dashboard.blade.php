            ...
            <div class="bg-[#FFF9F9] overflow-hidden shadow-sm sm:rounded-lg border border-[#F44171]">
                <div class="p-6">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <a href="{{ route('payments.create') }}" class="p-4 bg-white rounded-lg border text-[#F44171] border-[#F44171]/20 hover:bg-[#F44171] hover:text-white transition-colors duration-150">
