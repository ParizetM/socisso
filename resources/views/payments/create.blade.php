...
<div class="container mx-auto py-8">
    ...
    <form action="{{ route('payments.store') }}" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded shadow">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="amount" id="amount" step="0.01" required class="w-full border border-gray-300 rounded px-3 py-2" placeholder="0.00">
            @error('amount')
        ...
        <div class="mb-4">
            ...
            <input type="text" name="card_number" id="card_number" maxlength="16" required class="w-full border border-gray-300 rounded px-3 py-2" placeholder="xxxx-xxxx-xxxx-xxxx">
            @error('card_number')
                <small class="text-red-500">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cvc" id="cvc" maxlength="3" required class="w-full border border-gray-300 rounded px-3 py-2" placeholder="123">
            @error('cvc')
                <small class="text-red-500">{{ $message }}</small>
            @enderror
        </div>
